const morven_st_chloe = `
<div class="popupinfo">
<h2>Marven St Chloe</h2>
<div class="slides-map-label map-label-middle">
    <span class="mapStatusLabel"></span>
    <label class="checkbox-label">
        <input type="checkbox" id="checkbox" name="tick" class="checkbox" value="Morven St Chloe">
...
export default morven_st_chloe;