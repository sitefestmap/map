const caroline_jamfrey = `
<div class="popupinfo">
<h2>Caroline Jamfrey</h2>
<div class="slides-map-label map-label-middle">
    <span class="mapStatusLabel"></span>
    <label class="checkbox-label">
        <input type="checkbox" id="checkbox" name="tick" class="checkbox" value="Caroline Jamfrey">
...
export default caroline_jamfrey;